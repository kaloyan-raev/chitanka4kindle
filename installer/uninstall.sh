...
INST_LOG="/mnt/us/chitanka_uninstall.log"
...
logmsg "I" "remove" "Removing chitanka..."
if [ -f /mnt/us/documents/chitanka.azw2 ]; then
    rm -f /mnt/us/documents/chitanka.azw2 2>> ${INST_LOG}
    logmsg "I" "remove" "Success (chitanka.azw2)."
else
    logmsg "I" "warning" "Skip (chitanka.azw2 not found)."
fi
